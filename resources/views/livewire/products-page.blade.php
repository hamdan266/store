          ...
          <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div>
                ...
                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="50000000" value="300000" step="10000">
                <div class="flex justify-between ">
                  <span class="inline-block text-md font-xx-small text-blue-400 " style="font-size: 80%;">{{ Number::currency(100000, 'IDR') }}</span>
                  <span class="inline-block text-md font-xx-small text-blue-400 " style="font-size: 80%;">{{ Number::currency(50000000, 'IDR') }}</span>
                </div>
              </div>
            </div>
          </div>
